...
class ApiRestExternalStaffController extends Controller {

    /**
     * @Route("/api/queryExternalStaff")
     * @Method("GET")
     */
    public function queryExternalStaffAction(Request $request) {
            ...
            if ($data_token == false) {
                ...
                if ($user) {
                    if ($data_token["profile_is_default"] == "internal") {
                        ...
                        $array_staff = $medical_center->getExternalStaff();
                        ...
                        if (!empty($array_staff)) {
                            ...
                            $data = array('message' => 'There are no registered staff');
    ...
    /**
     * @Route("/api/queryOneExternalStaff")
     * @Method("POST")
     */
    public function queryOneExternalStaffAction(Request $request) {
    ...
    /**
     * @Route("/api/createExternalStaff")
     * @Method("POST")
     */
    public function createExternalStaffAction(Request $request) {
            ...
            if ($data_token == false) {
                ...
                if ($user) {
                    if ($data_token["profile_is_default"] == "internal") {
                        ...
                        $array_external_staff = $medical_center->getExternalStaff();
                        $dni = $request->request->get("dni");
                        $type_identity = $request->request->get("type_identity");

                        foreach ($array_external_staff as $aux) {
                            if ($aux['dni'] == $dni) {
                        ...
                        if ($type_identity == "") {
                            ...
                            $medical_center->setExternalStaff($array_external_staff);
    ...
    /**
     * @Route("/api/editExternalStaff")
     * @Method("POST")
     */
    public function editExternalStaffAction(Request $request) {
        /*Function responsible editing external staff*/
            ...
            if ($data_token == false) {
                ...
                if ($user) {
                    if ($data_token["profile_is_default"] == "internal") {
                        ...
                        /*Receiving data*/
                        $id_external_staff = $request->request->get("_id");
                        $type_identity = $request->request->get("type_identity");
                        $dni = $request->request->get("dni");
                        $names = $request->request->get("names");
                        $surnames = $request->request->get("surnames");
                        ...
                        if ($type_identity == "") {
                            ...
                            $count = 0;
                            foreach ($array_external_staff as $array_external_staff_edit) {
                                if ((string)$array_external_staff_edit['_id'] == $id_external_staff) {
                                    $array_external_staff[$count]['type_identity'] = $type_identity;
                                    $array_external_staff[$count]['dni'] = $dni;
                                    $array_external_staff[$count]['names'] = $names;
                                    $array_external_staff[$count]['surnames'] = $surnames;
                                    $array_external_staff[$count]['province_id'] = $province;
                                    $array_external_staff[$count]['district_id'] = $district;
                                    $array_external_staff[$count]['position_id'] = $position;
                                    $array_external_staff[$count]['profession_id'] = $profession;
                                    $array_external_staff[$count]['specialization_id'] = $specialization;
                                    $array_external_staff[$count]['address'] = $address;
                                    $array_external_staff[$count]['phone'] = $phone;
                                    $array_external_staff[$count]['email'] = $email;
                                    $array_external_staff[$count]['sex_id'] = $sex;
                                    $array_external_staff[$count]['civil_state_id'] = $civil_state;
                                    $array_external_staff[$count]['photo'] = $photo;
                                    $array_external_staff[$count]['birth_date'] = $birth_date;
                                    $array_external_staff[$count]['branchoffices_register'] = $branchoffices_register;
                                    $array_external_staff[$count]['active'] = $active;
                                    $array_external_staff[$count]['updated_at'] = $date_now;
                                    $array_external_staff[$count]['updated_by'] = $user_id;
